...
async function main() {
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 3,
      durationDays: 4,
      heroImageUrl: buildHeroSeedPublicUrl("osaka-kyoto"),
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 4,
      durationDays: 5,
      heroImageUrl: buildHeroSeedPublicUrl("tokyo-hakone"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 5,
      durationDays: 6,
      heroImageUrl: buildHeroSeedPublicUrl("danang-hoian"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 5,
      durationDays: 7,
      heroImageUrl: buildHeroSeedPublicUrl("phuket-villa"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 8,
      durationDays: 9,
      heroImageUrl: buildHeroSeedPublicUrl("paris-rome"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 9,
      durationDays: 10,
      heroImageUrl: buildHeroSeedPublicUrl("swiss-alps"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 4,
      durationDays: 6,
      heroImageUrl: buildHeroSeedPublicUrl("bali-budget"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 4,
      durationDays: 5,
      heroImageUrl: buildHeroSeedPublicUrl("cebu-family"),
      status: ProductStatus.PUBLISHED,
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 3,
      durationDays: 4,
      heroImageUrl: buildHeroSeedPublicUrl("fukuoka-food"),
  ...
  await prisma.product.create({
    data: {
      ...
      durationNights: 5,
      durationDays: 6,
      heroImageUrl: buildHeroSeedPublicUrl("boracay-draft"),
