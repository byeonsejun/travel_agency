...
// Cache Components(PPR): 추천 상품은 변동 빈도가 낮아 5분 캐시. getFeaturedProducts 가
// `use cache`(cacheLife revalidate:300)라 페이지가 정적 셸로 prerender + 데이터는 캐시 hit.
// 지역 탭은 표시 items 에서 도출(별도 쿼리 불요). [ADR-0053]
