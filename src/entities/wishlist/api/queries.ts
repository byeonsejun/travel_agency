...
// 헤더 뱃지용 카운트. UserNavIsland 가 /api/wishlist/count 로 client-fetch
// 하므로 매 mount 시 fresh. toggleWishlistAction 의 revalidatePath(returnTo)
// 후 island 가 다음 mount 때 자동 동기화 → 별도 캐시 태깅 불필요.
